        ...
        <div class="divide-y divide-slate-200 border border-slate-100 rounded-2xl shadow-sm">
            ...
            <div class="p-6">
                ...
                <div x-show="open === 1" x-transition class="mt-4 text-slate-700 leading-relaxed">
                    ...
                    Chúng tôi cũng khuyến khích khách hàng sử dụng dịch vụ một cách có trách nhiệm, tuân thủ 
                    các hướng dẫn của nhân viên và giữ gìn vệ sinh chung.
                    Nếu có bất kỳ thắc mắc nào về dịch vụ hoặc cần hỗ trợ, đừng ngần ngại liên hệ với 
                    chúng tôi qua điện thoại hoặc email. Chúng tôi luôn sẵn sàng giúp đỡ bạn!
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                <div x-show="open === 4" x-transition class="mt-4 text-slate-700 leading-relaxed">
                    BerryNice Spa công khai bảng giá dịch vụ. Quý khách có thể thanh toán bằng tiền mặt, thẻ hoặc ví điện tử.
                </div>
            </div>
